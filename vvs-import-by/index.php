...
для торговли с Россией</div>
		...
		<div class="main">
			<form id="vvs-import" action="" method="post">
				...
				?> class="block">
					<div id="step-button" class="button">Получите название товара, оптимального для торговли с Россией</div>
				</div>
		...
		<div id="window-sucess" class="window sucess hidden">
			...
			<div class="window-text">
				<p>Мы подобрали для Вас товары, выгодные для поставок в Россию. Посмотрите почту, там список товаров</p>
				<!--<p>P.S. Не забудьте проверить папку СПАМ</p>
