...
if($resultcheck == 0) { //если нет, командуем вывести пустой результат
  ...
  $message_admin_empty = "Поиск без результатов<br>Заполнен на Волгоградское ТТП<br>дата - $date_admin<br>mail - $mail<br>размер компании - $button_company<br>запрос позиция - $tn_pos";
...
<table style="border-spacing: 0;border-collapse: collapse;vertical-align: top" align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  echo "\t\t<td style=\"color: #2c3e50; padding: 5px; margin: 0; font-size: 14px; line-height: 17px; border-collapse: collapse; border: 1px solid #95a5a6;\" width=\"10%\" align=\"center\">Период стабиль-<br>ного / устойчив-<br>ого тренда*, мес.</td>\n";
  echo "\t\t<td style=\"color: #2c3e50; padding: 5px; margin: 0; font-size: 14px; line-height: 17px; border-collapse: collapse; border: 1px solid #95a5a6;\" width=\"15%\" align=\"center\">Объем импорта за 4 квартал 2016г., $</td>\n";
  echo "\t\t<td style=\"color: #2c3e50; padding: 5px; margin: 0; font-size: 14px; line-height: 17px; border-collapse: collapse; border: 1px solid #95a5a6;\" width=\"10%\" align=\"center\">Прирост импорта к аналогичному кварталу прошлого года, %</td>\n";
  echo "\t\t<td style=\"color: #2c3e50; padding: 5px; margin: 0; font-size: 14px; line-height: 17px; border-collapse: collapse; border: 1px solid #95a5a6;\" width=\"10%\" align=\"center\">Количество регионов России, закупающих товар</td>\n";
  echo "\t</tr>\n";
...
//Тело получателя
$contacts_vttp = '<p>По вопросам обращайтесь 8 800 555 3420, а также обратиться к нашему официальному  представителю на территории Волгоградской области - Союз "Волгоградская торгово-промышленная палата", Информационно-аналитический центр, Пурясева Анна Владимировна, тел. +7 8442 267 864, 415 016, +7 961 670 1095, e-mail: avpuryaseva@volgogradcci.ru, a.puryaseva2014@yandex.ru</p>';
$messageclient = "$textvvs0$formedtable$contacts_vttp$textvvs1";
//Тело получателя
...
$message_admin = "Заполнен на Волгоградское ТТП<br>дата - $date_admin<br>mail - $mail<br>размер компании - $button_company<br>запрос позиция - $tn_pos<br>запрос результат:<br>----<br>$formedtable<br>----";
