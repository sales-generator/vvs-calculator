...
if($resultcheck == 0) { //если нет, командуем вывести пустой результат
  ...
  $message_admin_empty = "Поиск без результатов<br>Заполнен на agtrans<br>дата - $date_admin<br>mail - $mail<br>размер компании - $button_company<br>запрос позиция - $tn_pos";
...
<table style="border-spacing: 0;border-collapse: collapse;vertical-align: top" align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  echo "\t\t<td style=\"color: #2c3e50; padding: 5px; margin: 0; font-size: 14px; line-height: 17px; border-collapse: collapse; border: 1px solid #95a5a6;\" width=\"15%\" align=\"center\">Объем импорта за 2 квартал 2017г., $</td>\n";
...
$message_admin = "Заполнен на agtrans<br>дата - $date_admin<br>mail - $mail<br>размер компании - $button_company<br>запрос позиция - $tn_pos<br>запрос результат:<br>----<br>$formedtable<br>----";
