...
$query = "SELECT
  `BASE_2016Q1`.tn_code,
  `BASE_2016Q1`.tn_name,
  `BASE_2016Q1`.tn_period,
  `BASE_2016Q1`.tn_money,
  `BASE_2016Q1`.tn_percentage,
  `BASE_2016Q1`.tn_region
FROM `BASE_2016Q1`
WHERE `BASE_2016Q1`.tn_pos = $search";
...
<table style="border-spacing: 0;border-collapse: collapse;vertical-align: top" align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
  ...
  echo "\t\t<td style=\"color: #2c3e50; padding: 5px; margin: 0; font-size: 14px; line-height: 17px; border-collapse: collapse; border: 1px solid #95a5a6;\" width=\"15%\" align=\"center\">Объем импорта за 4 квартал 2015г., $</td>\n";
